...
def get_train_parser():
    ...
    parser.add_argument("--aggregation", default='cls',type=str, required=False, help="dense aggregation strategy")
    parser.add_argument("--data_dir", default=None,type=str,required=False,help="dataset directory")
    ...
    parser.add_argument('--add_prefix', default=False, action='store_true', help="add input type prefix for mE5 model")
...
def get_index_parser():
    ...
    parser.add_argument("--checkpoint",default=None,type=str,help="custom model init checkpoint")
    parser.add_argument("--fitter_checkpoint",default=None,type=str,help="LEACE checkpoint")
    parser.add_argument("--seed", type=int, default=42, help="random seed for initialization")
